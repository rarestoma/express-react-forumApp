...
const QuestionRow = ({
  ...
  const handleEditQuestion = (data) => {
    SetModalEditQuestionOpen(!modalEditQuestionOpen);
    SetModalEditQuestionData(data);
  };
  ...
  return (
    <>
      ...
      >
        ...
        <td className="p-3 text-end">
          <a
            className="inline-block w-auto text-sm font-medium leading-normal text-center align-middle cursor-pointer rounded-lg transition-colors duration-150 ease-in-out text-white bg-primary shadow-none border-0 px-3 py-2 hover:bg-primary-dark active:bg-primary-dark focus:bg-primary-dark mb-2"
            onClick={() =>
              handleEditQuestion({
                id,
                question,
...
const QuestionsTable = () => {
  ...
  // State for the modal
  const [modalEditQuestionOpen, SetModalEditQuestionOpen] = useState(false);
  const [modalEditQuestionData, SetModalEditQuestionData] = useState("wow");
              ...
              <tbody className="font-semibold text-light-inverse">
                {questions.records.map((question) => (
                  <QuestionRow
                    ...
                    questionDescription={
                      question.fields["Question Description"]
                    }
                    ...
                    SetModalEditQuestionOpen={SetModalEditQuestionOpen}
                    modalEditQuestionOpen={modalEditQuestionOpen}
                    SetModalEditQuestionData={SetModalEditQuestionData}
                    modalEditQuestionData={modalEditQuestionData}
                  />
                ))}
              </tbody>
            </table>

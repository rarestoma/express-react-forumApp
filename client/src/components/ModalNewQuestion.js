...
import { useCreateQuestion } from "../queries/questions";
...
const ModalNewQuestion = ({
  ...
  const handleCreateQuestion = async (event, questionData) => {
  ...
  return (
    <div
      style={{ display: modalNewQuestionOpen ? "block" : "none" }}
      ...
      <div className="relative p-4 w-full max-w-2xl max-h-full m-auto mt-10">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="p-4 md:p-5 space-y-4">
            <form
              onSubmit={(event) => handleCreateQuestion(event, questionData)}
              className="px-3"
            >
              <label
              ...
              <input
                ...
                name="Company"
                id="Company"
                defaultValue={questionData["Company Name"]}
              ...
              <input
                ...
                name="Id"
                id="Id"
                defaultValue={questionData["_companyId"]}
                className="peer w-full px-4 py-3 text-base/normal rounded-xl font-medium block transition-colors duration-200 ease-in-out bg-secondary-light focus:bg-secondary/40 text-stone-500 border focus:outline-none mb-3"
                placeholder="xxxxxx"
                onChange={handleChange}
              />
